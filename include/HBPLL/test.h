...
static void test_HSDL(graph_v_of_v<int>& instance_graph)
{
	...
	{
		std::cout << ">>>iteration_graph_times: " << i << endl;
		...
		avg_time_initialization += mm.time_initialization;
		avg_time_generate_labels += mm.time_generate_labels;
		avg_time_sortL += mm.time_sortL;
		avg_time_canonical_repair += mm.time_canonical_repair;
		avg_canonical_repair_remove_label_ratio += mm.canonical_repair_remove_label_ratio;
		...
		avg_index_size_per_v += (double)index_size / instance_graph.size();
	...
	avg_index_time /= iteration_graph_times;
	avg_time_initialization /= iteration_graph_times;
	avg_time_generate_labels /= iteration_graph_times;
	avg_time_sortL /= iteration_graph_times;
	avg_time_canonical_repair /= iteration_graph_times;
	avg_canonical_repair_remove_label_ratio /= iteration_graph_times;
	avg_index_size_per_v /= iteration_graph_times;

	std::cout << "avg_canonical_repair_remove_label_ratio: " << avg_canonical_repair_remove_label_ratio << endl;
	std::cout << "avg_index_time: " << avg_index_time << "s" << endl;
	std::cout << "\t avg_time_initialization: " << avg_time_initialization << endl;
	std::cout << "\t avg_time_generate_labels: " << avg_time_generate_labels << endl;
	std::cout << "\t avg_time_sortL: " << avg_time_sortL << endl;
	std::cout << "\t avg_time_canonical_repair: " << avg_time_canonical_repair << endl;
	std::cout << "\t avg_index_size_per_v: " << avg_index_size_per_v << endl;
}
