#ifndef LDBC_GRAPH_HPP
#define LDBC_GRAPH_HPP
#pragma once
...
#include <utils/sorted_vector_ops.h>
...
public:
	...
	inline void graph_v_of_v_to_LDBC(graph_v_of_v<int> &input_graph);
...
template <typename weight_type>
void LDBC<weight_type>::graph_v_of_v_to_LDBC(graph_v_of_v<int> &input_graph) {
